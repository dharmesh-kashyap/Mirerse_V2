    ...
    <div className="bg-pink-600 pt-12 sm:pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="https://www.producthunt.com/posts/Mirerse?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-Mirerse"
            target="_blank"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=314294&theme=light"
              alt="Mirerse - Just like Dribbble, but for developers | Product Hunt"
              width="250"
              height="54"
